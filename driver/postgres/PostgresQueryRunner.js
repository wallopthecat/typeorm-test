...
var PostgresQueryRunner = /** @class */ (function (_super) {
                ...
                switch (_b.label) {
                    ...
                    case 9:
                        ...
                        if (!((newColumn.type === "enum" || newColumn.type === "simple-enum")
                            ...
                            && !OrmUtils_1.OrmUtils.isArraysEqual(newColumn.enum, oldColumn.enum))) return [3 /*break*/, 23];
                        if (!(oldColumn.isArray && !newColumn.isArray)) return [3 /*break*/, 17];
                        if (!newColumn.isNullable) return [3 /*break*/, 13];
                        upQueries.push(new Query_1.Query("ALTER TABLE " + this.escapePath(table) + " ALTER COLUMN \"" + oldColumn.name + "\" TYPE " + this.buildEnumName(table, newColumn, true, false, false) + " USING \"" + oldColumn.name + "\"[1]::" + this.buildEnumName(table, newColumn, true, false, false)));
                        if (!oldColumn.isNullable) return [3 /*break*/, 10];
                        downQueries.push(new Query_1.Query("ALTER TABLE " + this.escapePath(table) + " ALTER COLUMN \"" + oldColumn.name + "\" TYPE " + this.buildEnumName(table, oldColumn, true, false, false) + "[] USING ARRAY[\"" + oldColumn.name + "\"]"));
                        return [3 /*break*/, 12];
                    case 10: return [4 /*yield*/, this.getDropColumnQueries(tableOrName, newColumn)];
                    case 11:
                        downQueries_1 = (_b.sent()).downQueries;
                        downQueries_1.push.apply(downQueries_1, tslib_1.__spread(downQueries_1));
                        _b.label = 12;
                    case 12: return [3 /*break*/, 16];
                    case 13: 
                    // No migration strategic. There could be values with empty arrays. Therefore the new column needs to be nullable.
                    return [4 /*yield*/, this.dropColumn(tableOrName, oldColumn)];
                    case 14:
                        // No migration strategic. There could be values with empty arrays. Therefore the new column needs to be nullable.
                        _b.sent();
                        return [4 /*yield*/, this.addColumn(tableOrName, newColumn)];
                    case 15:
                        _b.sent();
                        _b.label = 16;
                    case 16: return [3 /*break*/, 23];
                    case 17:
                        if (!(!oldColumn.isArray && newColumn.isArray)) return [3 /*break*/, 21];
                        // enum -> enum[]
                        upQueries.push(new Query_1.Query("ALTER TABLE " + this.escapePath(table) + " ALTER COLUMN \"" + oldColumn.name + "\" TYPE " + this.buildEnumName(table, newColumn, true, false, false) + "[] USING ARRAY[\"" + oldColumn.name + "\"]"));
                        if (!(oldColumn.isNullable || newColumn.isNullable)) return [3 /*break*/, 19];
                        return [4 /*yield*/, this.getDropColumnQueries(tableOrName, oldColumn)];
                    case 18:
                        downQueries_2 = (_b.sent()).downQueries;
                        downQueries_2.push.apply(downQueries_2, tslib_1.__spread(downQueries_2));
                        return [3 /*break*/, 20];
                    case 19:
                        downQueries.push(new Query_1.Query("ALTER TABLE " + this.escapePath(table) + " ALTER COLUMN \"" + oldColumn.name + "\" TYPE " + this.buildEnumName(table, newColumn, true, false, false) + " USING \"" + oldColumn.name + "\"[1]"));
                        _b.label = 20;
                    ...
                    case 23:
                        ...
                        _b.label = 24;
                    case 24: return [4 /*yield*/, this.executeQueries(upQueries, downQueries)];
                    case 25:
                        _b.sent();
                        this.replaceCachedTable(table, clonedTable);
                        return [2 /*return*/];
    ...
    PostgresQueryRunner.prototype.getDropColumnQueries = function (tableOrName, columnOrName) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
    ...
    PostgresQueryRunner.prototype.dropColumn = function (tableOrName, columnOrName) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var _a, upQueries, downQueries, clonedTable, table, column;
            return tslib_1.__generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, this.getDropColumnQueries(tableOrName, columnOrName)];
                    case 1:
                        _a = _b.sent(), upQueries = _a.upQueries, downQueries = _a.downQueries, clonedTable = _a.clonedTable, table = _a.table, column = _a.column;
                        return [4 /*yield*/, this.executeQueries(upQueries, downQueries)];
                    case 2:
                        _b.sent();
